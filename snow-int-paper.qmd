...
Could include more analysis here showing steps to get to choosing 45 deg as best VZA and comparison of LAI, Canopy closure, and dist. to nearest tree.
:::
...
![Cumulative canopy snow storage measured using the subcanopy lysimeters plotted against cumulative event snowfall for five selected snowfall events. The colour of each line shows the average air temperature over the duration of each event.](figs/interception/cuml_event_snowfall_canopy_storage_scl.png){#fig-scl-w-sf}
