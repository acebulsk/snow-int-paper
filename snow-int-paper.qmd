---
title: "The influence of canopy structure and wind-driven snowfall on snow interception in a subalpine environment"
...
**Novelty and International Appeal Statement:** In this novel study, we present new observations of snow accumulation in a subalpine forest that traverse temporal and spatial scales. These new observations are utilized to develop a new snow interception parameterization that, unlike existing models, attempts to separate canopy snow loading from ablative processes. This updated model enhances clarity in simulating subcanopy snow accumulation by better distinguishing between these processes, and is consistent with the rainfall interception literature, thereby advancing our understanding of snow dynamics in forested regions across the globe.

Snowmelt directly supplies water to over 2 billion people, crucial for downstream ecosystems, energy production, drinking water supply and agricultural irrigation. Land surface schemes used for predicting climate change and carbon cycling depend on accurate estimates of snow accumulation on the ground and in the canopy for energy balance equations. Therefore, there is a need to observe and predict this vital source of water. Current remote sensing methods are limited in observing snow accumulation beneath the canopy, and thus models are needed to predict current, past and future snow accumulation in forests. Our research improves process understanding of snow interception and has the potential to improve estimates of subcanopy snowpack, supporting better water resource management and climate adaptation strategies worldwide.

**Keywords:** snow, interception, throughfall, subcanopy, snowpack, subalpine, canopy coverage, lidar
...
**Abstract:** Existing models of subcanopy snow accumulation are based on limited observations, differ in how snow interception and ablation processes are represented, and need to be revisited in the context of more diverse study sites and modern methodologies. Subcanopy throughfall was measured within a subalpine forest in the Canadian Rockies using methods high frequency point scale measurements and UAV-lidar point-in-time fine-scale (5 cm) measurements across two forest plots. Canopy structure metrics were quantified across the study site using voxel ray sampling of lidar (VoxRS) at a high resolution (5 cm). Existing theory on snow interception such as the influence of air temperature and canopy snow load on interception efficiency were not observed in the point-scale data collected from this site. The association between fine-scale measurements of canopy structure and throughfall reveal that at the forest plot scale, UAV-lidar measurements show that forest structure is the most important factor governing snow accumulation. Throughfall measurements from a wind-driven snowfall event reveal that improved prediction of interception efficiency was found when adjusted for hydrometeor trajectory angle. Leaf contact area was found to be very sensitive to wind speed, increasing by up to 95% with a horizontal wind velocity of 1 m s^-1^ and resulting in a significant reduction in throughfall observed across two forest plots. These effects are combined into two new equations which model snow interception efficiency as a function of leaf contact area adjusted for hydrometeor trajectory angle. This new method proved successful in estimating interception efficiency for a snowfall event with R^2^ values of 0.70 and 0.61 for the two forest plots in this study. This new interception model attempts to minimize the inclusion of ablative processes in this parameterization, and should help minimize the double counting of ablation as is typically combined with additional ablative parameterizations available in the literature.

# Introduction

Over half of North America's snowy headwaters are covered by forests [@Kim2017], significantly impacting the accumulation and redistribution of subcanopy snowpacks and subsequent snowmelt runoff. Researchers have estimated that across the globe, 25–45% of annual snowfall may be lost to the atmosphere due to sublimation of snow intercepted in the canopy [@Essery2003]. Snow intercepted in the canopy can sublimate and melt at much higher rates compared to subcanopy snowpack, reducing the amount of snow available for runoff [@Lundberg1994; @Pomeroy1998b]. Forest thinning efforts aimed at limiting sublimation losses and increase snow accumulation by [@Golding1978; @Harpold2020; @Troendle1983] sometimes have unintended consequences for snowmelt runoff. This may be due to increased ablation rates when forest cover is reduced and a limited prior process understanding [@Ellis2013; @Musselman2015a; @Pomeroy1997; @Varhola2010; @Safa2021]. Vegetation structure controls the partitioning of snowfall into throughfall and interception, and thus governs the quantity of snow subject to sublimation [@Hedstrom1998a; @Storck2002]. The time that snow resides in the canopy, and is available for high rates of sublimation depends on unloading rates [@Hedstrom1998a; @Roesch2001], canopy snowmelt [@Mahat2014], and wind redistribution [@Wheeler1987]. Due to the significant impact of forest cover on snow accumulation and ablation, and the absence of a regional scale monitoring network of forest snow accumulation [@Vionnet2021; @Rittger2020], land management, ecological conservation and water resource decisions rely on robust models of snow redistribution to estimate past, current and future subcanopy snowpacks. Such models require a comprehensive understanding of snow interception and ablation processes. 

Numerous field-based studies have developed methodologies to quantify the fraction of snowfall intercepted in the canopy. These methods, discussed in detail in @Cebulski2024b, include snow surveys mass balance [@Hedstrom1998a], tree weighing [@Satterlund1967; @Schmidt1991; @Lundberg1993; @Hedstrom1998a; @Storck2002; @Katsushima2023], gamma ray attenuation [@Calder1990] and subcanopy lysimeters [@Storck2002]. @Cebulski2024b noes the care needed in using these methods to isolate interception from ablative processes. As a result, existing parameterizations for interception and ablation processes must be used in the context of the measurements used to derive them. Previous studies have collected measurements of interception efficiency over timesteps ranging from hourly [@Storck2002] to weekly [@Hedstrom1998a]. The varying measurement time intervals affect the duration during which ablative processes can influence these measurements, potentially impacting model estimates of interception and leading to potential underestimations of the fraction of snow intercepted in the canopy.

This may explain the over estimation of subcanopy snow accumulation reported by @Lundquist2021 and @Lumbrazo2022 when combining the @Hedstrom1998a routine with ablation parameterizations from different studies [e.g., @Roesch2001]. However, @Gelfan2004 demonstrated accurate subcanopy snowpack simulations by treating the @Hedstrom1998a and @Storck2002 parameterizations separately. They employed a step-based function to choose either the @Hedstrom1998a or @Storck2002 parameterization based on temperature conditions. This approach was assessed at field sites across the globe in various climates. The calculation of the maximum interception capacity, which snow interception parameterizations utilize to reduce the fraction of snow that is intercepted in the canopy as it approaches the capacity, differs substantially between existing studies [see Figure 6 in @Cebulski2024b]. Recent work by @Lundquist2021 found improved subcanopy snowpack simulations when they omitted the canopy snow storage capacity from @Hedstrom1998a, while utilizing a complete representation of ablation processes. This suggests for parameterizations involving snow loading in the canopy, incorporating a canopy snow storage capacity may not be necessary. However, ablative processes could benefit from an interception storage capacity, particularly in regions that are prone to rime-ice formation, which can limit canopy snow ablation [@Lumbrazo2022] and can lead to heavy snow loads causing stem breakage [@Lehtonen2014; @Lehtonen2016].

The extent that processes observed to be important at the point scale, such as bridging of gaps in canopy elements [@Satterlund1967], or branch bending [@Schmidt1991; @Pomeroy1995; @Hedstrom1998a], influence snow accumulations at the forest plot scale remain uncertain. Fine-scale observations of throughfall have only recently become feasible at this extent, presenting an opportunity to provide more definitive answers to how interception efficiency varies over space [@Harder2020; @Staines2023]. Existing theory proposed by @Hedstrom1998a suggests that moderate wind speeds, which result in horizontal hydrometeor trajectories, can increase leaf contact area and increase interception efficiency at the plot scale. This association has been shown in rainfall interception studies [i.e., @Herwitz1995; @VanStan2011] to have a significant influence on observed throughfall. Despite this importance for rainfall, this relationship proposed by @Hedstrom1998a, is typically ignored in models [e.g., @Mahat2014; @Clark2020], as empirical support for this relationship is lacking and also exhibits a relatively low sensitivity [see figure 8 in @Cebulski2024b]. New methods developed by @Staines2023 to provide canopy structure metrics at a high angular and spatial resolution have the potential to better understand the relationship between snow interception and forest structure spatially and also across differing trajectory angles.

The objective of this paper is to evaluate the influence of canopy structure and meteorological conditions on snow interception using high-frequency point scale and high spatial resolution measurements of subcanopy snow accumulation that attempt to minimize inclusion of ablative processes. These new observations are investigated to address the following research questions: 1) Do the existing theories regarding the relationship between meteorology and canopy snow load on interception efficiency align with these observations? 2) How is snow interception influenced by non-vertical hydrometeor trajectory angles over a wind-driven snowfall event? 3) To what extent can these findings inform the development of a new parameterization for snow interception?
...
To determine how forest structure was associated with interception efficiency at different azimuth and zenith angles over the March 13-14 snowfall event, each portion of the hemisphere at each grid location was considered. The relationship between interception efficiency and canopy contact number was found to be linear and thus the Pearson Correlation Coefficient, $\rho_p$ was calculated to quantify the association between a single raster of interception efficiency and 32'760 rasters containing the canopy contact number hemisphere for each portion of the hemisphere (azimuth [0°, 1°, ..., 359°], zenith angle [0°, 1°, ..., 90°]). 

# Results

## The influence of meteorology on snow interception

The meteorology, state of canopy snow load, and interception efficiency was measured for 26 distinct snowfall events. The state of canopy snow load with event cumulative snowfall, calculated using the SCLs and snowfall gauge, is shown in @fig-scl-w-sf for each of the 26 snowfall events. Canopy snow load was observed in @fig-scl-w-sf to increase linearly with increasing snowfall without evidence of reaching a maximum canopy storage capacity. Variation in the slope of each line in @fig-scl-w-sf, is attributed to differences in the meteorology and antecedent canopy snow load within and between the individual events. Variations in the canopy structure surrounding the SCL instruments as shown in @tbl-scl-lai-cc, also contributed to the difference in slope. The absence of canopy storage and interception efficiency measurements for certain troughs during specific events was caused by damage to the subcanopy lysimeter wiring due to animal interference and snow load.
...
@fig-lca-vs-ip shows that the linear relationship between $C_p$ and interception efficiency, when resampled to a 5 m resolution, is stronger when $C_p$ is adjusted for the observed shift in hydrometeor trajectory, with zenith angles (0° – 30°) and azimuth angles (170° – 220°), compared to the nadir leaf contact angle (zenith angle of 0°). The strong association between adjusted $C_p$ has the potential to be a predictor of interception efficiency, before ablation. An equation to represent this linear relationship is proposed here as:
...
![Scatter plots showing the relationship between leaf contact area and interception efficiency rasters resampled to a 5 m grid cell resolution. The Adjusted plots (first column) show the leaf contact area averaged over rasters with zenith angles (0°, 1°, ... 30°) and azimuth angles (170°, 171°, ... 220°). The Nadir plots (second column) show leaf contact area measured from a zenith angle of 0°. The solid lines show the ordinary least squares linear regression fit to the observed data for the PWL (red) and FT (black) forest plots and the light grey dotted line shows a 1:1 line. ](../../analysis/lidar-processing/figs/voxrs/scatter/pwl_ft_lca_vs_ip_phi_nadir_adjusted_resample_w_mods_5m.png){#fig-lca-vs-ip}
...
-   A new snow interception parameterization has been presented which calculates initial interception, before canopy snow ablation, as a function of snowfall rate and leaf contact area which is consistent with the rainfall interception literature and recent observations of snow interception. 
-   A second equation is proposed to estimate the increase leaf contact area due to hydrometeor trajectory angle from nadir canopy coverage. This relationship was shown to follow a relatively similar relationship at two forest plots with differing canopy structure and could be represented by a single parameterization. 
-   Good performance of this updated snow interception parameterization has been shown in this subalpine forest, but further validation should be conducted in a range of climate and forest structures. Caution should be taken in using this updated interception routine with existing canopy snow ablation parameterizations as they were developed using earlier snow interception routines that also included ablative processes. Future work will involve revising canopy snow ablation routines to work with this new snow interception routine.
