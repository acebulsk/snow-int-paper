---
title: "Decoupling snow interception and ablation processes in hydrological models: insights from high-resolution spatial and temporal observations from a subalpine forest"
...
**Novelty and International Appeal Statement:** In this study, we present new observations of snow accumulation at a high spatial and temporal resolution collected from a subalpine forest. These observations are utilized to develop a new snow interception parameterization that attempts to decouple canopy snow loading from ablative processes. This updated model enhances clarity in simulating subcanopy snow accumulation by better distinguishing between these processes, and is consistent with the rainfall interception literature. Further advancements are made to snow interception process understanding by providing empirical evidence of increased snow interception during a wind-driven snowfall event. These developments to snow interception process understanding will help model snow accumulation and redistribution in forested regions across the globe.

Snowmelt directly supplies water to over 2 billion people, crucial for downstream ecosystems, energy production, drinking water supply and agricultural irrigation. Hydrological models and land surface schemes used for predicting water resources, climate change and carbon cycling depend on accurate estimates of snow accumulation on the ground and in the canopy. Therefore, there is a need to observe and predict this vital source of water. Current remote sensing methods are limited in observing snow accumulation beneath the canopy, and thus models are needed to predict current, past and future snow accumulation in forests. Our research aims to improve process understanding of snow interception supporting improved water resource management and climate adaptation strategies worldwide.
...
To determine how forest structure was associated with interception efficiency at different azimuth and zenith angles over the March 13-14 snowfall event, each portion of the hemisphere at each grid location was considered. The relationship between interception efficiency and canopy contact number was found to be linear and thus the Pearson Correlation Coefficient, $\rho_p$ was calculated to quantify the association between a single raster of interception efficiency and the 32'760 rasters containing the canopy contact number hemisphere for each portion of the hemisphere (azimuth [0°, 1°, ..., 359°], zenith angle [0°, 1°, ..., 90°]). 

# Results

## The influence of meteorology on snow interception

@fig-scl-w-sf depicts the state of canopy snow load with increasing cumulative snowfall, as measured for 26 snowfall events using the SCLs and snowfall gauge. Canopy snow load was observed in @fig-scl-w-sf to increase linearly with increasing snowfall without evidence of reaching a maximum canopy storage capacity. Variation in the slope of each line in @fig-scl-w-sf, is attributed to differences in the meteorology and antecedent canopy snow load within and between the individual events. Variations in the canopy structure surrounding the SCL instruments as shown in @tbl-scl-lai-cc, also contributed to the difference in slope. The absence of canopy snow load measurements in @fig-scl-w-sf for certain troughs during specific events was caused by damage to the subcanopy lysimeter wiring due to animal interference and snow load.
