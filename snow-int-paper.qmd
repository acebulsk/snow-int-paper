...
A 15 m tall flux tower provided measurements within the SRF site provided measurements of the meterological conditions at 15-min time intervals (@fig-map-site). The meterological variables used in this study include air temperature, relative humidity and wind speed (4.5 m above the ground). A weighing precipitation gauge (OTT Pluvio) provided measurements of the snowfall rate ($q_{sf}$) to an open clearing adjacent to the study area shown in @fig-map-site. The snowfall rate was corrected for undercatch following phase correction by @Harder2013 and catch efficiency by @Macdonald2007a.
