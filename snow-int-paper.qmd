...
where $\overline{u}$ is average wind speed (m s^-1^) at height, $z$ (m) above the ground, $u_*$ is the friction velocity (m s^-1^), $d_0$ is the displacement height (m), $z_0$ is the roughness length of momentum (m), and $k$ is the von Kármán Constant (-).
