...
<!-- Figure legends should be concise but comprehensive – the figure and its legend must be understandable without reference to the text. Include definitions of any symbols and define/explain all abbreviations and units of measurement. To aid placement, ensure that figures are referenced and located within the text (e.g. [Insert Figure 1]). Figures should be uploaded as separate files at the time of submission. -->
