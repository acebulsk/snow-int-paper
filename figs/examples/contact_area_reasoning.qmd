...
The goal is to calculate the snow-leaf contact area, $C_p$, for non-vertical snowfall compared to vertical. The contact area for vertical snowfall is equal to the canopy coverage $C_c$. For vertical snowfall, the width of canopy contacted is equal to the base width. As snow becomes non vertical this width increases as shown in @fig-tri.
