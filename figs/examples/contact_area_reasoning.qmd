...
The goal is to calculate the snow-leaf contact area, $C_p$. For vertical snowfall the contact area is equal to the canopy coverage $C_c$. As snow becomes non vertical this width increases as shown in @fig-tri.
